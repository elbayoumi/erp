...
class CollectController extends Controller
{
    public function index()
    {
        ...
        $mov_type = HelperClass::get_cols_where(new Mov_type(), array("id", "name"), array("active" => 1, 'in_screen' => 2, 'is_private_internal' => 0), 'id', 'ASC');
    ...
    public function store(Collect_transactionRequest $request)
    {
        try {
            ...
            $treasury_date = HelperClass::get_cols_where_row(new Treasuries(), array("last_isal_collect"), array("com_code" => $com_code, "id" => $request->treasuries_id));
