...
<a href="{{ route('inv_stores_transfer.index') }}">     التحويل بين المخازن</a>
@endsection
      ...
      <div class="card">
         ...
         <div class="card-body">
               ...
               <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                     ...
                     <td >
                        ...
                        <a href="{{ route('inv_stores_transfer.delete',$data['id']) }}" class="btn btn-sm are_you_shue  btn-danger">حذف</a>
                        @endif
                        <a href="{{ route('inv_stores_transfer.edit',$data['id']) }}" class="btn btn-sm btn-success">تعديل</a>
                        @if($data['items_counter']>0 and $data['notgiveStatecounter_details']==0)
                        <a href="{{ route('inv_stores_transfer.do_approve',$data['id']) }}"  class="btn btn-sm btn-primary are_you_shue">  اغلاق وأرشفة الامر</a>
                        @endif
                        @endif
                     </td>
                  </tr>
            ...
            <div class="card-header">
               ...
               <input type="hidden" id="ajax_get_item_uoms_url" value="{{ route('inv_stores_transfer.get_item_uoms') }}">
               <input type="hidden" id="ajax_Add_item_to_invoice" value="{{ route('inv_stores_transfer.Add_item_to_invoice') }}">
               <input type="hidden" id="ajax_reload_itemsdetials" value="{{ route('inv_stores_transfer.reload_itemsdetials') }}">
               <input type="hidden" id="ajax_reload_parent_pill" value="{{ route('inv_stores_transfer.reload_parent_pill') }}">
               <input type="hidden" id="ajax_load_edit_item_details" value="{{ route('inv_stores_transfer.load_edit_item_details') }}">
               <input type="hidden" id="ajax_load_modal_add_details" value="{{ route('inv_stores_transfer.load_modal_add_details') }}">
               <input type="hidden" id="ajax_edit_item_details" value="{{ route('inv_stores_transfer.edit_item_details') }}">
               <input type="hidden" id="ajax_get_item_batches" value="{{ route('inv_stores_transfer.get_item_batches') }}">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <a href="{{ route('inv_stores_transfer.delete_details',["id"=>$info->id,"id_parent"=>$data['id']]) }}" class="btn btn-sm are_you_shue   btn-danger">حذف</a>
                           @endif
