...
<div class="card">
   <div class="card-header">
      ...
      <input type="hidden" id="ajax_search_url" value="{{ route('stores_inventory.ajax_search') }}">
      <a href="{{ route('stores_inventory.create') }}" class="btn btn-sm btn-success" >اضافة جديد</a>
   </div>
   <!-- /.card-header -->
   <div class="card-body">
      <div class="row">
               ...
               <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           @if($info->is_closed==0)
                           <a href="{{ route('stores_inventory.edit',$info->id) }}" class="btn btn-sm  btn-success">تعديل</a>
                           <a href="{{ route('stores_inventory.delete',$info->id) }}" class="btn btn-sm are_you_shue  btn-danger">حذف</a>
                           @endif
                           <a href="{{ route('stores_inventory.show',$info->id) }}" class="btn btn-sm   btn-info">التفاصيل</a>
                           <a style="font-size: .875rem; padding: 0.25rem 0.5rem;color:white" target="_blank" href="{{ route('stores_inventory.printsaleswina4',[$info->id,'A4']) }}" class="btn btn-primary btn-xs"> WA4</a>
                        </td>
                     </tr>
                     @php
                     $i++;
