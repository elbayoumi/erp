...
<a href="{{ route('stores_inventory.index') }}">   جرد المخازن </a>
@endsection
      ...
      <div class="card">
         ...
         <div class="card-body">
               ...
               <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                     ...
                     <td >
                        ...
                        @endif
                        @if($data['is_closed']==0)
                        <a href="{{ route('stores_inventory.delete',$data['id']) }}" class="btn btn-sm are_you_shue  btn-danger">حذف</a>
                        <a href="{{ route('stores_inventory.edit',$data['id']) }}" class="btn btn-sm btn-success">تعديل</a>
                        <a href="{{ route('stores_inventory.do_close_parent',$data['id']) }}" class="btn btn-sm are_you_shue  btn-primary">اغلاق وترحيل أمر الجرد</a>
                        @endif
                     </td>
                  </tr>
               </table>
            ...
            <div class="card-header">
               ...
               <input type="hidden" id="ajax_load_edit_item_details" value="{{ route('stores_inventory.load_edit_item_details') }}">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <a href="{{ route('stores_inventory.close_one_details',['id'=>$info->id,'id_parent'=>$data['id']]) }}" class="btn btn-sm are_you_shue  btn-success">ترحيل</a>
                           <a href="{{ route('stores_inventory.delete_details',['id'=>$info->id,'id_parent'=>$data['id']]) }}" class="btn btn-sm are_you_shue  btn-danger">حذف</a>
                           @else
                           مغلق ومرحل
                           @endif
                        </td>
   ...
   <div class="modal-dialog modal-xl" >
      <div class="modal-content bg-info">
         ...
         <div class="modal-body" id="Add_item_Modal_body" style="background-color: white !important; color:black;">
            <form action="{{ route('stores_inventory.add_new_details',$data['id']) }}" method="post" >
            @csrf
