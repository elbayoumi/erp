...
<div class="card">
   <div class="card-header">
      ...
      <input type="hidden" id="ajax_search_url" value="{{ route('inv_production_exchange.ajax_search') }}">
      <a href="{{ route('inv_production_exchange.create') }}" class="btn btn-sm btn-success" >اضافة جديد</a>
   </div>
   <!-- /.card-header -->
   <div class="card-body">
      <div class="row">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <a href="{{ route('inv_production_exchange.edit',$info->id) }}" class="btn btn-sm  btn-primary">تعديل</a>
                           <a href="{{ route('inv_production_exchange.delete',$info->id) }}" class="btn btn-sm are_you_shue  btn-danger">حذف</a>
                           @endif
                           <a href="{{ route('inv_production_exchange.show',$info->id) }}" class="btn btn-sm   btn-info">التفاصيل</a>
                           <a style="font-size: .875rem; padding: 0.25rem 0.5rem;color:white" target="_blank" href="{{ route('inv_production_exchange.printsaleswina4',[$info->id,'A4']) }}" class="btn btn-primary btn-xs"> WA4</a>
                           <a style="font-size: .875rem; padding: 0.25rem 0.5rem;color:white" target="_blank" href="{{ route('inv_production_exchange.printsaleswina4',[$info->id,'A6']) }}" class="btn btn-warning btn-xs"> WA6</a>
                        </td>
                     </tr>
                     @php
                     $i++;
