...
<a href="{{ route('inv_production_exchange.index') }}">   صرف الخامات للورش</a>
@endsection
      ...
      <div class="card">
         ...
         <div class="card-body">
               ...
               <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                     ...
                     <td >
                        ...
                        <a href="{{ route('inv_production_exchange.delete',$data['id']) }}" class="btn btn-sm are_you_shue  btn-danger">حذف</a>
                        <a href="{{ route('inv_production_exchange.edit',$data['id']) }}" class="btn btn-sm btn-success">تعديل</a>
            ...
            <div class="card-header">
               ...
               <input type="hidden" id="ajax_get_item_uoms_url" value="{{ route('inv_production_exchange.get_item_uoms') }}">
               <input type="hidden" id="ajax_Add_item_to_invoice" value="{{ route('inv_production_exchange.Add_item_to_invoice') }}">
               <input type="hidden" id="ajax_reload_itemsdetials" value="{{ route('inv_production_exchange.reload_itemsdetials') }}">
               <input type="hidden" id="ajax_reload_parent_pill" value="{{ route('inv_production_exchange.reload_parent_pill') }}">
               <input type="hidden" id="ajax_load_edit_item_details" value="{{ route('inv_production_exchange.load_edit_item_details') }}">
               <input type="hidden" id="ajax_load_modal_add_details" value="{{ route('inv_production_exchange.load_modal_add_details') }}">
               <input type="hidden" id="ajax_edit_item_details" value="{{ route('inv_production_exchange.edit_item_details') }}">
               <input type="hidden" id="ajax_load_modal_approve_invoice" value="{{ route('inv_production_exchange.load_modal_approve_invoice') }}">
               <input type="hidden" id="ajax_load_usershiftDiv" value="{{ route('inv_production_exchange.load_usershiftDiv') }}">
               <input type="hidden" id="ajax_get_item_batches" value="{{ route('inv_production_exchange.get_item_batches') }}">
               ...
               <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           @if($data['is_approved']==0)
                           <a href="{{ route('inv_production_exchange.delete_details',["id"=>$info->id,"id_parent"=>$data['id']]) }}" class="btn btn-sm are_you_shue   btn-danger">حذف</a>
                           @endif
                        </td>
                     </tr>
                     @php
