...
<a href="{{ route('suppliers_orders.index') }}">  فواتير المشتريات </a>
@endsection
      ...
      <div class="card">
         ...
         <div class="card-body">
               ...
               <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                     ...
                     <td >
                        ...
                        <a href="{{ route('suppliers_orders.delete',$data['id']) }}" class="btn btn-sm are_you_shue  btn-danger">حذف</a>
                        <a href="{{ route('suppliers_orders.edit',$data['id']) }}" class="btn btn-sm btn-success">تعديل</a>
            ...
            <div class="card-header">
               ...
               <input type="hidden" id="ajax_get_item_uoms_url" value="{{ route('suppliers_orders.get_item_uoms') }}">
               <input type="hidden" id="ajax_add_new_details" value="{{ route('suppliers_orders.add_new_details') }}">
               <input type="hidden" id="ajax_reload_itemsdetials" value="{{ route('suppliers_orders.reload_itemsdetials') }}">
               <input type="hidden" id="ajax_reload_parent_pill" value="{{ route('suppliers_orders.reload_parent_pill') }}">
               <input type="hidden" id="ajax_load_edit_item_details" value="{{ route('suppliers_orders.load_edit_item_details') }}">
               <input type="hidden" id="ajax_load_modal_add_details" value="{{ route('suppliers_orders.load_modal_add_details') }}">
               <input type="hidden" id="ajax_edit_item_details" value="{{ route('suppliers_orders.edit_item_details') }}">
               <input type="hidden" id="ajax_load_modal_approve_invoice" value="{{ route('suppliers_orders.load_modal_approve_invoice') }}">
               <input type="hidden" id="ajax_load_usershiftDiv" value="{{ route('suppliers_orders.load_usershiftDiv') }}">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           ...
                           <a href="{{ route('suppliers_orders.delete_details',["id"=>$info->id,"id_parent"=>$data['id']]) }}" class="btn btn-sm are_you_shue  btn-danger">حذف</a>
                           @endif
                        </td>
                     </tr>
                     @php
