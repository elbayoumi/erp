...
@section('contentheaderlink')
    <a href="{{ route('inv_stores_transfer_incoming.index') }}"> التحويل بين المخازن</a>
@endsection
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div id="ajax_responce_serarchDivparentpill">
                        <input type="hidden" id="ajax_load_cancel_one_details"
                            value="{{ route('inv_stores_transfer_incoming.load_cancel_one_details') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($info->is_approved == 0 and $data['is_approved'] == 0 and $info->is_canceld_receive == 0)
                                                    <a href="{{ route('inv_stores_transfer_incoming.approve_one_details', ['id' => $info->id, 'id_parent' => $data['id']]) }}"
                                                        class="btn btn-sm are_you_shue   btn-success">اعتماد واستلام
                                                        الكمية</a>
                                                    <button data-id="{{ $info->id }}"
                                                        class="btn btn-sm  ajax_load_cancel_one_details   btn-danger"> رفض
                                                        استلام الكمية</button>
                                                @endif
    ...
    <div class="modal fade " id="load_cancel_one_details">
        <div class="modal-dialog modal-xl">
            <div class="modal-content bg-info">
                ...
                <div class="modal-body" id="load_cancel_one_details_body"
