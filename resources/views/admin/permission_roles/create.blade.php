        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title card_title_center"> اضافة دور صلاحية جديد </h3>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="{{ route('permission_roles.store') }}" method="post">
                        @csrf
                        ...
                        <div class="form-group text-center">
                            ...
                            <a href="{{ route('permission_roles.index') }}" class="btn btn-sm btn-danger">الغاء</a>
                        </div>
                    </form>
                </div>
            </div>
