...
<a href="{{ route('accounts.index') }}">    العملاء </a>
@endsection
...
<div class="card">
   <div class="card-header">
      ...
      <input type="hidden" id="ajax_search_url" value="{{ route('customer.ajax_search') }}">
      <a href="{{ route('customer.create') }}" class="btn btn-sm btn-success" >اضافة جديد</a>
   </div>
   <!-- /.card-header -->
   <div class="card-body">
      <div class="row">
