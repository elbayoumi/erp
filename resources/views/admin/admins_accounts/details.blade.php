               ...
               <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <a href="{{ route('admins_accounts.delete_treasuries',['rowid'=>$info->id,'userid'=>$data['id'] ]) }}" class="btn btn-sm btn-danger are_you_shue">حذف</a>
                        </td>
                     </tr>
                     @php
                     $i++;
   ...
   <table id="example2" class="table table-bordered table-hover">
      ...
      <tbody>
         ...
         <tr>
            ...
            <td>
               <a href="{{ route('admins_accounts.delete_stores',['rowid'=>$info->id,'userid'=>$data['id'] ]) }}" class="btn btn-sm btn-danger are_you_shue">حذف</a>
            </td>
         </tr>
         @php
         $i++;
   ...
   <div class="modal-dialog modal-xl"  >
      <div class="modal-content bg-info">
         ...
         <div class="modal-body"  style="background-color: white !important; color:black;" >
            <form action="{{ route('admins_accounts.add_treasuries',$data['id']) }}" method="post" >
               @csrf
...
<div class="modal fade "   id="Add_storesModal">
   <div class="modal-dialog modal-xl"  >
      <div class="modal-content bg-info">
         ...
         <div class="modal-body"  style="background-color: white !important; color:black;" >
            <form action="{{ route('admins_accounts.add_stores',$data['id']) }}" method="post" >
               @csrf
               <div class="form-group">
                  <label>   بيانات  الخزن</label>
