      ...
      <nav class="mt-2">
         ...
         @endif
            ...
            <li class="nav-item has-treeview {{ ( (request()->is('admin/accountTypes*')||request()->is('admin/accounts*')  ||request()->is('admin/customer*')  ||request()->is('admin/suppliers_categories*') ||request()->is('admin/supplier*') ||(request()->is('admin/collect_transaction*') ||request()->is('admin/exchange_transaction*') ||request()->is('admin/delegates*') )) && !request()->is('admin/suppliers_orders*')  )?'menu-open':''  }}     ">
               ...
               <ul class="nav nav-treeview">
                  <li class="nav-item">
                     <a href="{{ route('accountTypes.index') }}" class="nav-link {{ (request()->is('admin/accountTypes*'))?'active':'' }}">
                        <p>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('suppliers_categories.index') }}" class="nav-link {{ (request()->is('admin/suppliers_categories*') )?'active':'' }}">
                        <p>
                           فئات الموردين
                        </p>
                     </a>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('supplier.index') }}" class="nav-link {{ (request()->is('admin/supplier*') and !request()->is('admin/suppliers_categories*') )?'active':'' }}">
                        <p>
                           حسابات الموردين
                        </p>
                     </a>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('collect_transaction.index') }}" class="nav-link {{ (request()->is('admin/collect_transaction*') )?'active':'' }}">
                        <p>
                           شاشة تحصيل النقدية
                        </p>
                     </a>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('exchange_transaction.index') }}" class="nav-link {{ (request()->is('admin/exchange_transaction*') )?'active':'' }}">
                        <p>
                           شاشة صرف النقدية
                        </p>
                     </a>
            ...
            <li class="nav-item has-treeview {{ ((request()->is('admin/sales_matrial_types*')||request()->is('admin/stores*') ||request()->is('admin/uoms*') ||request()->is('admin/inv_itemcard_categories*')||request()->is('admin/itemcard*'))and !request()->is('admin/itemcardBalance*')  and !request()->is('admin/stores_inventory*') )?'menu-open':'' }}     ">
               ...
               <ul class="nav nav-treeview">
                  <li class="nav-item">
                     <a href="{{ route('sales_matrial_types.index') }}" class="nav-link {{ (request()->is('admin/sales_matrial_types*') )?'active':'' }}">
                        *
                        <p>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('uoms.index') }}" class="nav-link {{ (request()->is('admin/uoms*') )?'active':'' }}">
                        *
                        <p>
                           بيانات الوحدات
                        </p>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('itemcard.index') }}" class="nav-link {{ (request()->is('admin/itemcard*') )?'active':'' }}">
                        *
                        <p>
                           الاصناف
                        </p>
            ...
            <li class="nav-item has-treeview {{ (request()->is('admin/suppliers_orders*') ||request()->is('admin/suppliers_orders_general_return*') ||request()->is('admin/itemcardBalance*') ||request()->is('admin/stores_inventory*') ||request()->is('admin/inv_stores_transfer*') ||request()->is('admin/inv_stores_transfer_incoming*') )?'menu-open':'' }}     ">
               ...
               <ul class="nav nav-treeview">
                  <li class="nav-item">
                     <a href="{{ route('suppliers_orders.index') }}" class="nav-link {{ (request()->is('admin/suppliers_orders*') and !request()->is('admin/suppliers_orders_general_return*') )?'active':'' }}">
                        <p>
                           فواتير المشتريات
                        </p>
                     </a>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('suppliers_orders_general_return.index') }}" class="nav-link {{ (request()->is('admin/suppliers_orders_general_return*')  )?'active':'' }}">
                        <p>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('inv_stores_transfer.index') }}" class="nav-link {{ (request()->is('admin/inv_stores_transfer*') and  !request()->is('admin/inv_stores_transfer_incoming*')  )?'active':'' }}">
                        <p>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('inv_stores_transfer_incoming.index') }}" class="nav-link {{ (request()->is('admin/inv_stores_transfer_incoming*')  )?'active':'' }}">
                        <p>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('stores_inventory.index') }}" class="nav-link {{ (request()->is('admin/stores_inventory*')  )?'active':'' }}">
                        <p>
                           جرد المخازن
                        </p>
                     </a>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('itemcardBalance.index') }}" class="nav-link {{ (request()->is('admin/itemcardBalance*')  )?'active':'' }}">
                        <p>
                           أرصدة الأصناف
                        </p>
                     </a>
            ...
            <li class="nav-item has-treeview  {{ (request()->is('admin/inv_production_order*')  || request()->is('admin/inv_production_lines*') || request()->is('admin/inv_production_exchange*')  ||request()->is('admin/inv_production_Receive*'))?'menu-open':'' }}    ">
               ...
               <ul class="nav nav-treeview  ">
                  <li class="nav-item">
                     <a href="{{ route('inv_production_lines.index') }}" class="nav-link {{ (request()->is('admin/inv_production_lines*')  )?'active':'' }}">
                        <p>
                           خطوط الانتاج
                        </p>
                     </a>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('inv_production_order.index') }}" class="nav-link {{ (request()->is('admin/inv_production_order*')  )?'active':'' }}">
                        <p>
                           أوامر التشغيل
                        </p>
                     </a>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('inv_production_exchange.index') }}" class="nav-link {{ (request()->is('admin/inv_production_exchange*')  )?'active':'' }}">
                        <p>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('inv_production_Receive.index') }}" class="nav-link {{ (request()->is('admin/inv_production_Receive*')  )?'active':'' }}">
                        <p>
            ...
            <li class="nav-item has-treeview {{ (request()->is('admin/SalesInvoices*') || request()->is('admin/SalesReturnInvoices*'))?'menu-open':'' }}     ">
               ...
               <ul class="nav nav-treeview">
                  <li class="nav-item">
                     <a href="{{ route('SalesInvoices.index') }}" class="nav-link {{ (request()->is('admin/SalesInvoices*') )?'active':'' }}">
                        <p>
                           فواتير المبيعات
                        </p>
                     </a>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('SalesReturnInvoices.index') }}" class="nav-link {{ (request()->is('admin/SalesReturnInvoices*') )?'active':'' }}">
                        <p>
            ...
            <li class="nav-item has-treeview  {{ (request()->is('admin/Services*') ||request()->is('admin/Services_orders*'))?'menu-open':'' }}    ">
               ...
               <ul class="nav nav-treeview  ">
                  <li class="nav-item">
                     <a href="{{ route('Services.index') }}" class="nav-link {{ (request()->is('admin/Services*')  and !request()->is('admin/Services_orders*'))?'active':'' }}">
                        <p>
                           ضبط الخدمات
                        </p>
                     </a>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('Services_orders.index') }}" class="nav-link {{ (request()->is('admin/Services_orders*')  )?'active':'' }}">
                        <p>
                           فواتير الخدمات
                        </p>
                     </a>
            ...
            <li class="nav-item has-treeview {{ (request()->is('admin/admin_shift*'))?'menu-open':'' }}     ">
               ...
               <ul class="nav nav-treeview">
                  <li class="nav-item">
                     <a href="{{ route('admin_shift.index') }}" class="nav-link {{ (request()->is('admin/admin_shift*') )?'active':'' }}">
                        <p>
                           شفتات الخزن
                        </p>
                     </a>
            ...
            <li class="nav-item has-treeview {{ (request()->is('admin/FinancialReport*') || request()->is('admin/customeraccountmirror*') ||request()->is('admin/FinancialReport/delegateaccountmirror') )?'menu-open':'' }}     ">
               ...
               <ul class="nav nav-treeview">
                  <li class="nav-item">
                     <a href="{{ route('FinancialReport.supplieraccountmirror') }}" class="nav-link {{ (request()->is('admin/FinancialReport/supplieraccountmirror') )?'active':'' }}">
                        <p>
                           كشف حساب مورد
                        </p>
                     </a>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('FinancialReport.customeraccountmirror') }}" class="nav-link {{ (request()->is('admin/FinancialReport/customeraccountmirror') )?'active':'' }}">
                        <p>
                           كشف حساب عميل
                        </p>
                     </a>
                  ...
                  <li class="nav-item">
                     <a href="{{ route('FinancialReport.delegateaccountmirror') }}" class="nav-link {{ (request()->is('admin/FinancialReport/delegateaccountmirror') )?'active':'' }}">
                        <p>
                           كشف حساب مندوب
                        </p>
                     </a>
