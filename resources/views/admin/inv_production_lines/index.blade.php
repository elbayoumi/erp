...
<a href="{{ route('inv_production_lines.index') }}">    ورش الانتاج </a>
@endsection
...
<div class="card">
   <div class="card-header">
      ...
      <input type="hidden" id="ajax_search_url" value="{{ route('inv_production_lines.ajax_search') }}">
      <a href="{{ route('inv_production_lines.create') }}" class="btn btn-sm btn-success" >اضافة جديد</a>
   </div>
   <!-- /.card-header -->
   <div class="card-body">
      <div class="row">
         ...
         <table id="example2" class="table table-bordered table-hover">
            ...
            <tbody>
               ...
               <tr>
                  ...
                  <td>
                     <a href="{{ route('inv_production_lines.edit',$info->id) }}" class="btn btn-sm  btn-primary">تعديل</a>
                  </td>
               </tr>
               @endforeach
            </tbody>
