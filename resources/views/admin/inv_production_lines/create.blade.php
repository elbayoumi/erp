...
<div class="card">
   <div class="card-header">
      <h3 class="card-title card_title_center"> اضافة حساب خط انتاج جديد</h3>
   </div>
   <!-- /.card-header -->
   <div class="card-body">
      <form action="{{ route('inv_production_lines.store') }}" method="post" >
         <div class="row">
            @csrf
            <div class="col-md-6">
               <div class="form-group">
                  <label>اسم   ورشة خط الانتاج</label>
            ...
            <div class="col-md-12">
               <div class="form-group text-center">
                  ...
                  <a href="{{ route('inv_production_lines.index') }}" class="btn btn-sm btn-danger">الغاء</a>
               </div>
            </div>
         </div>
      </form>
