...
<a href="{{ route('accounts.index') }}">    المناديب </a>
@endsection
...
<div class="card">
   ...
   <!-- /.card-header -->
   <div class="card-body">
      <form action="{{ route('delegates.update',$data['id']) }}" method="post" >
         <div class="row">
            @csrf
            <div class="col-md-6">
            ...
            <div class="col-md-12">
               <div class="form-group text-center">
                  ...
                  <a href="{{ route('delegates.index') }}" class="btn btn-sm btn-danger">الغاء</a>
               </div>
            </div>
         </div>
      </form>
