         ...
         <div class="card-body">
            ...
            <div class="card-header">
               <h3 class="card-title card_title_center">الخزن الفرعية التي سوف تسلم عهدتها الي الخزنة ( {{ $data['name'] }} )
                  <a href="{{ route('treasuries.Add_treasuries_delivery',$data['id']) }}" class="btn btn-sm btn-primary">اضافة جديد</a>
               </h3>
            </div>
               ...
               <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <a href="{{ route('treasuries.delete_treasuries_delivery',$info->id) }}" class="btn btn-sm btn-danger are_you_shue">حذف</a>
                        </td>
                     </tr>
                     @php
                     $i++;
