                    ...
                    @if (@isset($data) && !@empty($data))
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    @else
                                        لايوجد تحديث
                                    @endif
                                    <a href="{{ route('treasuries.edit', $data['id']) }}"
                                        class="btn btn-sm btn-success">تعديل</a>
                                    <a href="{{ route('treasuries.index') }}" class="btn btn-sm btn-info">عودة</a>
                                </td>
                            </tr>
                        </table>
                        <!--  treasuries_delivery   -->
                        <div class="card-header">
                            <h3 class="card-title card_title_center">الخزن الفرعية التي سوف تسلم عهدتها الي الخزنة (
                                {{ $data['name'] }} )
                                <a href="{{ route('treasuries.Add_treasuries_delivery', $data['id']) }}"
                                    ...
                                    <tbody>
                                        @foreach ($treasuries_delivery as $info)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('treasuries.delete_treasuries_delivery', $info->id) }}"
