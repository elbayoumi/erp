                        ...
                        <form action="{{ route('treasuries.update', $data['id']) }}" method="post"
                            ...
                            <div class="form-group">
                                ...
                                <input name="name" id="name" class="form-control"
                                    value="{{ old('name', $data['name']) }}" placeholder="ادخل اسم الشركة"
                            ...
                            <div class="form-group">
                                ...
                                <select name="is_master" id="is_master" class="form-control">
                                    ...
                                    <option {{ old('is_master', $data['is_master']) == 1 ? 'selected' : '' }} value="1">
                                        نعم</option>
                                    <option {{ old('is_master', $data['is_master']) == 0 ? 'selected' : '' }} value="0">
                                        لا</option>
                                </select>
                                @error('is_master')
                                    <span class="text-danger">{{ $message }}</span>
