...
@section('content')
    <div class="card">
        <div class="card-header">
            ...
            <input type="hidden" id="ajax_get_item_uoms" value="{{ route('SalesInvoices.get_item_uoms') }}">
            <input type="hidden" id="ajax_get_load_modal_addMirror"
                value="{{ route('SalesInvoices.load_modal_addMirror') }}">
            <input type="hidden" id="ajax_get_load_modal_addActiveInvoice"
                value="{{ route('SalesInvoices.load_modal_addActiveInvoice') }}">
            ...
            <input type="hidden" id="ajax_get_load_invoice_update_modal"
                value="{{ route('SalesInvoices.load_invoice_update_modal') }}">
            <input type="hidden" id="ajax_get_Add_item_to_invoice"
                value="{{ route('SalesInvoices.Add_item_to_invoice') }}">
            <input type="hidden" id="ajax_get_reload_items_in_invoice"
                value="{{ route('SalesInvoices.reload_items_in_invoice') }}">
            <input type="hidden" id="ajax_get_recalclate_parent_invoice"
                value="{{ route('SalesInvoices.recalclate_parent_invoice') }}">
            <input type="hidden" id="ajax_get_remove_active_row_item"
                value="{{ route('SalesInvoices.remove_active_row_item') }}">
            <input type="hidden" id="ajax_DoApproveInvoiceFinally"
                value="{{ route('SalesInvoices.DoApproveInvoiceFinally') }}">
            ...
            <input type="hidden" id="ajax_load_invoice_details_modal"
                value="{{ route('SalesInvoices.load_invoice_details_modal') }}">
            ...
            <input type="hidden" id="ajax_getlastaddedcustomer"
                value="{{ route('SalesInvoices.get_last_added_customer') }}">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @if ($info->is_approved == 0)
                                                    ...
                                                    <a href="{{ route('SalesInvoices.delete', $info->id) }}"
                                                ...
                                                <a style="font-size: .875rem; padding: 0.25rem 0.5rem;color:white"
                                                    target="_blank"
                                                    href="{{ route('SalesInvoices.printsaleswina4', [$info->id, 'A4']) }}"
                                                    class="btn btn-primary btn-xs"> WA4</a>
                                                <a style="font-size: .875rem; padding: 0.25rem 0.5rem;color:white"
                                                    target="_blank"
                                                    href="{{ route('SalesInvoices.printsaleswina4', [$info->id, 'A6']) }}"
