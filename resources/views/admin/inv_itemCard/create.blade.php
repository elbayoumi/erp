...
<div class="card">
   ...
   <!-- /.card-header -->
   <div class="card-body">
      <input type="hidden" id="ajax_url_ajax_check_barcode" value="{{ route('itemcard.ajax_check_barcode') }}" >
      <input type="hidden" id="ajax_url_ajax_check_name" value="{{ route('itemcard.ajax_check_name') }}" >
