...
<div class="card">
   <div class="card-header">
      ...
      <input type="hidden" id="ajax_search_url" value="{{ route('itemcard.ajax_search') }}">
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td>
                        ...
                        <a target="_blank" href="{{ route('itemcard.generate_barcode',$info->id) }}" class="btn btn-sm   btn-success">باركود <i class="fa fa-print"></i></a>
