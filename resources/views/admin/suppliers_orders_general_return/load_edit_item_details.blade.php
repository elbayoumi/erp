            ...
            <div class="row">
                ...
                <div class="col-md-4 relatied_to_itemCard">
                    <div class="form-group">
                        ...
                        <input oninput="this.value=this.value.replace(/[^0-9]/g,'');" id="quantity_add"
                ...
                <div class="col-md-4 relatied_to_itemCard">
                    <div class="form-group">
                        ...
                        <input oninput="this.value=this.value.replace(/[^0-9]/g,'');" id="price_add"
                ...
                <div class="col-md-4 relatied_to_itemCard">
                    <div class="form-group">
                        ...
                        <input readonly id="total_add" class="form-control"
