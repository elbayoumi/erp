...
@section('contentheaderlink')
    <a href="{{ route('suppliers_orders_general_return.index') }}"> فواتير مرتجع المشتريات العام </a>
@endsection
                ...
                <div class="card-body">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        @if ($data['is_approved'] == 0)
                                            <a href="{{ route('suppliers_orders_general_return.delete', $data['id']) }}"
                                                class="btn btn-sm are_you_shue  btn-danger">حذف</a>
                                            <a href="{{ route('suppliers_orders_general_return.edit', $data['id']) }}"
                    ...
                    <div class="card-header">
                        ...
                        <input type="hidden" id="ajax_get_item_uoms_url"
                            value="{{ route('suppliers_orders_general_return.get_item_uoms') }}">
                        <input type="hidden" id="ajax_Add_item_to_invoice"
                            value="{{ route('suppliers_orders_general_return.Add_item_to_invoice') }}">
                        <input type="hidden" id="ajax_reload_itemsdetials"
                            value="{{ route('suppliers_orders_general_return.reload_itemsdetials') }}">
                        <input type="hidden" id="ajax_reload_parent_pill"
                            value="{{ route('suppliers_orders_general_return.reload_parent_pill') }}">
                        <input type="hidden" id="ajax_load_edit_item_details"
                            value="{{ route('suppliers_orders_general_return.load_edit_item_details') }}">
                        <input type="hidden" id="ajax_load_modal_add_details"
                            value="{{ route('suppliers_orders_general_return.load_modal_add_details') }}">
                        <input type="hidden" id="ajax_edit_item_details"
                            value="{{ route('suppliers_orders_general_return.edit_item_details') }}">
                        <input type="hidden" id="ajax_load_modal_approve_invoice"
                            value="{{ route('suppliers_orders_general_return.load_modal_approve_invoice') }}">
                        <input type="hidden" id="ajax_load_usershiftDiv"
                            value="{{ route('suppliers_orders_general_return.load_usershiftDiv') }}">
                        <input type="hidden" id="ajax_get_item_batches"
                            value="{{ route('suppliers_orders_general_return.get_item_batches') }}">
                                ...
                                <tbody>
                                    @foreach ($details as $info)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($data['is_approved'] == 0)
                                                    <a href="{{ route('suppliers_orders_general_return.delete_details', ['id' => $info->id, 'id_parent' => $data['id']]) }}"
                                                        class="btn btn-sm are_you_shue   btn-danger">حذف</a>
                                                @endif
