        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ route('permission_main_menues.create') }}" class="btn btn-sm btn-success">اضافة جديد</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($data as $info)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('permission_main_menues.edit', $info->id) }}"
                                                    class="btn btn-sm  btn-primary">تعديل</a>
                                                <a href="{{ route('permission_main_menues.delete', $info->id) }}"
