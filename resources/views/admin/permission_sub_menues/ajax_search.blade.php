...
<table id="example2" class="table table-bordered table-hover">
   ...
   <tbody>
      ...
      <tr>
         ...
         <td>
            <a href="{{ route('permission_sub_menues.edit',$info->id) }}" class="btn btn-sm  btn-primary">تعديل</a>
            <a href="{{ route('permission_sub_menues.delete',$info->id) }}" class="btn are_you_shue btn-sm  btn-danger">حذف</a>
