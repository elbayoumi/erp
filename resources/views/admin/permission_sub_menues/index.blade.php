        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <input type="hidden" id="ajax_do_add_permission"
                        value="{{ route('permission_sub_menues.ajax_do_add_permission') }}">
                    <input type="hidden" id="ajax_load_edit_permission"
                        value="{{ route('permission_sub_menues.ajax_load_edit_permission') }}">
                    <input type="hidden" id="ajax_do_edit_permission"
                        value="{{ route('permission_sub_menues.ajax_do_edit_permission') }}">
                    <input type="hidden" id="ajax_do_delete_permission"
                        value="{{ route('permission_sub_menues.ajax_do_delete_permission') }}">


                    <a href="{{ route('permission_sub_menues.create') }}" class="btn btn-sm btn-success">اضافة جديد</a>
                </div>
                <!-- /.card-header -->
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-4">
                            ...
                            <input autofocus type="text" id="search_by_text" placeholder="بحث بالاسم"
                                class="form-control">
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                <label> البحث بالقوائم الرئيسية</label>
                                <select name="permission_main_menues_id_search" id="permission_main_menues_id_search"
                                    class="form-control ">
                                ...
                                <tbody>
                                    @foreach ($data as $info)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('permission_sub_menues.edit', $info->id) }}"
                                                    class="btn btn-sm  btn-primary">تعديل</a>
                                                <a href="{{ route('permission_sub_menues.delete', $info->id) }}"
                                                    class="btn are_you_shue btn-sm  btn-danger">حذف</a>

                                                <button data-id="{{ $info->id }}"
                                                    class="btn btn-sm btn-success load_add_permission_btn"> اضافة صلاحيات
                                                </button>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="7">
                                                @if (
                                                    @isset($info->permission_sub_menues_actions) &&
                                                        !@empty($info->permission_sub_menues_actions) &&
                                                        count($info->permission_sub_menues_actions) > 0)
                                                        ...
                                                        <tbody>
                                                            @foreach ($info->permission_sub_menues_actions as $action)
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button data-id="{{ $action->id }}"
                                                                            class="btn btn-sm btn-info load_edit_permission_btn">
                                                                            تعديل </button>
                                                                        <button data-id="{{ $action->id }}"
                                                                            class="btn btn-sm btn-danger do_delete_permisson_btn">
                                                                            حذف </button>
    ...
    <div class="modal fade  " id="add_permission_modal">
        <div class="modal-dialog modal-xl">
            <div class="modal-content bg-info">
                ...
                <div class="modal-body" id="add_permission_modalBody"
                    style="background-color: white !important; color:black;">
                    <div class="form-group">
                        <label>اسم الصلاحية</label>
                        <input name="permission_name_modal" id="permission_name_modal" class="form-control" value=""
                            placeholder="ادخل اسم الصلاحية" oninvalid="setCustomValidity('من فضلك ادخل هذا الحقل')"
    ...
    <div class="modal fade  " id="edit_permission_modal">
        <div class="modal-dialog modal-xl">
            <div class="modal-content bg-info">
                ...
                <div class="modal-body" id="edit_permission_modalBody"
                    style="background-color: white !important; color:black;">
