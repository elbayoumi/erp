            ...
            <div class="card">
                ...
                <div class="card-body">
                    @if (@isset($data) && !@empty($data))
                        <form action="{{ route('permission_sub_menues.update', $data['id']) }}" method="post">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <select name="permission_main_menues_id" id="permission_main_menues_id"
                                    class="form-control ">
                                    ...
                                    @if (@isset($Permission_main_menues) && !@empty($Permission_main_menues))
                                        @foreach ($Permission_main_menues as $info)
                                            <option
                                                {{ old('permission_main_menues_id', $data['permission_main_menues_id']) == $info->id ? 'selected' : '' }}
                            ...
                            <div class="form-group text-center">
                                ...
                                <a href="{{ route('permission_sub_menues.index') }}"
