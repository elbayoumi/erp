...
<a href="{{ route('accounts.index') }}">    تقرير مندوب </a>
@endsection
...
<div class="card">
   ...
   <!-- /.card-header -->
   <div class="card-body">
      <form target="_blank" action="{{ route('FinancialReport.delegateaccountmirror') }}" method="POST">
         @csrf
         <div class="row">
            <div class="col-md-4">
               <div class="form-group">
                  <input type="hidden" id="todaydate" value="@php echo date('Y-m-d'); @endphp">
                  <input type="hidden" id="ajax_searchforcustomer" value="{{ route('FinancialReport.searchforcustomer') }}">
