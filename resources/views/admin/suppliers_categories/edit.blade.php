...
@section('contentheaderlink')
    <a href="{{ route('suppliers_categories.index') }}"> فئات الموردين </a>
@endsection
            ...
            <div class="card">
                ...
                <div class="card-body">
                    @if (@isset($data) && !@empty($data))
                        <form action="{{ route('suppliers_categories.update', $data['id']) }}" method="post">
                            @csrf
                            ...
                            <div class="form-group text-center">
                                ...
                                <a href="{{ route('suppliers_categories.index') }}" class="btn btn-sm btn-danger">الغاء</a>
                            </div>
                        </form>
                    @else
